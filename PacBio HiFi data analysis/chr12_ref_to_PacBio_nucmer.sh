#!/bin/sh
######## chr12 #########
samtools faidx /data1/CluHar/Genomes/Assembly_v2.0.2/Ch_v2.0.2.fasta chr12:17326318-26103093 > chr12.fasta
...
out_dir="/data1/CluHar/PacBio/CCS_data/Inversions/chr12/complete_inversion/500kb_flanking/"
...
echo "samtools faidx /data1/CluHar/Genomes/Assembly_v2.0.2/Ch_v2.0.2.fasta chr12:17326318-26103093 > Ref.fasta" >> ${analysis_dir}${i}/fasta/samtools_faidx.sh
